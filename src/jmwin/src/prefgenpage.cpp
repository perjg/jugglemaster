...
#ifdef _DEVICE_RESOLUTION_AWARE
void JMPrefGenPage::OnSize(UINT /*nType*/, int /*cx*/, int /*cy*/)
{
	DRA::RelayoutDialog(
		AfxGetInstanceHandle(), 
		this->m_hWnd, 
		DRA::GetDisplayMode() != DRA::Portrait ? MAKEINTRESOURCE(IDD_PROP_GENERAL_WIDE) : MAKEINTRESOURCE(IDD_PROP_GENERAL));
}
#endif
