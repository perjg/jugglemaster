...
#ifdef _DEVICE_RESOLUTION_AWARE
void JMSelectPatternDlg::OnSize(UINT /*nType*/, int /*cx*/, int /*cy*/)
{
	DRA::RelayoutDialog(
		AfxGetInstanceHandle(), 
		this->m_hWnd, 
		DRA::GetDisplayMode() != DRA::Portrait ? MAKEINTRESOURCE(IDD_SELECTPATT_WIDE) : MAKEINTRESOURCE(IDD_SELECTPATT));
}
#endif
